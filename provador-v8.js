...
(function () {
    ...
    (function() {
        function injectPLBadge() {
            try {
                ...
                a.textContent = 'Provador Virtual de Roupas com IA — Provou Levou';
                b.appendChild(a);
    ...
    // ===============================================
    const apiKey = "pl_live_f1c9a00bc5c84e3feab4fac560b6e67bb95cbe2279c4551b078ae6e2abce1b72";
    window.PROVOU_LEVOU_API_KEY = apiKey;

    const WEBHOOK_PROVA = 'https://n8n.segredosdodrop.com/webhook/quantic-materialize';
    const LOGO_URL = ''; // Removido logo imagem

    LOG.info('Script carregado — Provador Virtual Marandola Modas (Nuvemshop)');
